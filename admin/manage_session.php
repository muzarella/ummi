      ...
      <?php include('./includes/left_bar.php') ;    ?>
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line">This allows you to Manage Session year of the school. </h1>
        ...
        ?>
                    <tr>
                        ...
                        <td>
                          <a href="edit_session.php?session_id=<?php echo htmlentities($result->session_id);?>"> Edit <i class="fa fa-edit" title="Edit Record"></i> </a> 
                         </td>
                        <td>
                            <a href="../modal/modal_class.php?del_sessionid=<?php echo htmlentities($result->session_id);?>"> Delete <i class="fa fa-close" title="delete Record"></i> </a> 
                        </td>
                   </tr>
                   <?php 
                   $count = $count +1 ;
