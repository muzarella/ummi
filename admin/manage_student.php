...
if(!empty( $result1->class_id)){
    $class_id = $result1->class_id;
 echo  $class_id;
}else {
//   $error = "Please contact your admin in order to manage student";
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line">This allows you to Manage Student number of your class. </h1>
...
<p> Select class to view all student  </p>
                <!-- begginging of select  -->  
                    <div class="col-sm-10">
                       <select name="class_id" class="form-control" id="class_name" onChange="get_student(this.value);" required="required">
...
<!-- get stable from  ajax script  -->
<div class="col-md-12" id="get_student">

</div>
<!-- end of getting table from ajax script  -->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
           <a href="" id="edit">  <button class="btn btn-default"> Edit  </button></a>
