         ...
         <!-- /. ROW BEGINNING -->
            ...
            <form class="form-horizontal" method="post"  action="../modal/modal_subject.php">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="subject_name" class="form-control" id="subject_name" placeholder="Enter subject name please e.g Mathematics " required="required" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-labbel col-sm-2"> Subject short Code</label>
                    <div class="col-sm-10">
                        <input type="text" name="subject_code" class="form-control" id="subject_code" placeholder="Enter subject code e.g Math  " required="required" />
                    </div>
                </div>
                
                <div class="form-group has-success">
                    <div class="col-sm-2" style="float: right;" >
                        <button type="submit" name="create_subject_List" class="btn btn-success btn-labeled" id="submit_create_class" > Submit <span class="btn-label btn-label-right"> <i class="fa fa-check" style="font-size:20px"></i></span> </button>
                    </div>
                </div>
            </form>  
            </div>
