...
// get the class name of the teacher from his id ;
$query1 = $obj-> show_class_teacherid($teacher_id) ;
$result1 = $query1->fetch(PDO::FETCH_OBJ) ;
 /*use the teacher id(pri 1) to select the student class 
 if (pri 1) is the teacher teaching get all d student
  in that class */ 
...
$class= $query2->fetch(PDO::FETCH_OBJ) ;
         ...
         echo htmlentities($class->class_code) ; ?> </td>
                        ...
                        <td>
                            <a href="edit_result.php?student_id=<?php echo htmlentities($student->student_id);?>"> Edit scores  <i class="fa fa-edit" title="Edit Record"></i> </a> 
                         </td>
                        <td>
