...
if(!empty( $result1->class_id)){
    ...
    $error = "Please contact your admin in order to view students result";

    echo "<script> alert('Please contact your admin in order to manage student'); </script>";
    echo "<script type='text/javascript'>document.location='../views/index.html'</script>";
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line">This allows you to view Student result  in your class. </h1>
                         <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        <li><a href="dashboard.php"><i class="fa fa-home"></i> Home</a></li>
                                        <li> student</li>
                                        <li class="active">view student result </li>
                                    </ul>
                                </div>
...
$class= $query2->fetch(PDO::FETCH_OBJ) ;
         ...
         echo htmlentities($class->class_code) ; ?> </td>
                        ...
                        <td>
                            <a href="show_result.php?student_id=<?php echo htmlentities($student->student_id);?>&class_id=<?php echo htmlentities($class_id);?>"> view result <i class="fa fa-edit" title="Edit Record"></i> </a> 
                         </td>
                        <td>
