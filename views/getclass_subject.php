...
*/
        ?>
                        ...
                        <td>
                            <a href="edit_subject.php?subject_id=<?php echo htmlentities($result->subject_id);?>"> Edit <i class="fa fa-edit" title="Edit Record"></i> </a> 
                         </td>
                       <!--  <td>
                            <a href="../modal/modal_subject.php?classid=<?php // echo htmlentities($result->subject_id);?>"> Delete <i class="fa fa-close" title="delete Record"></i> </a> 
                        </td> -->
                   </tr>
                   <?php 
                   $count = $count +1 ;
